...
def Text_To_Speech(text,model,speaker_feature,save_path):
...
def up():
    ...
    if speaker_feature == '0':
        ...
        speaker_feature = v2id.get_feature(model,config,'/workspace/Chater/input_ref.wav')
    ...
    ret = Text_To_Speech(res,speaker_feature,'/workspace/Chater/response.mp3')
    # 检测文件是否生成
